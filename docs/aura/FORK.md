...
| `packages/metaharness/README.md` | documents the broad compact-surface runtime benchmark, the focused inherent-capability comparison and gates, resumable frozen campaigns, report outputs, focused run modes, and opt-in process-vs-embedded decision run |
