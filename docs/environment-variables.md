...
| `AURA_EVAL_JS_ENGINE`        | Per-process override for the `eval.jsEngine` setting: `bun` or `elide`. Empty values are ignored; an unrecognized value throws. Mirrors `AURA_RUNTIME_ADAPTER`; stored `eval.jsEngine` remains the persistent configuration.                                                                                                                                                                                                                                                                                                                                                                |
