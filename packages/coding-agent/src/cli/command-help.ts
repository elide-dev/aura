...
export const acpHelp = {
	description: "Run Aura as an ACP (Agent Client Protocol) server over stdio",
...
export const doctorHelp = {
	description: "Report environment readiness (identity, runtime, natives, tools, plugins, terminal, memory)",
} satisfies CommandMetadata;
...
export const runtimeHelp = { description: "Manage the innate code runtime" } satisfies CommandMetadata;
...
export const worktreeHelp = {
	description: `List or clear agent-managed git worktrees (~/${CONFIG_DIR_NAME}/wt)`,
} satisfies CommandMetadata;
